...
class EasyFrame extends Frame implements Runnable {
	public static final int WIDTH = 1000, HEIGHT = 1000;
	private final int INITIAL_ATTACKERS = 150;
	private final int Sleep_Event = 5;
	private long DT = 20;
	private final double AVOIDER_SPEED = 5, ATTACKER_SPEED = 3, SLEEP_SPEED= 3;
